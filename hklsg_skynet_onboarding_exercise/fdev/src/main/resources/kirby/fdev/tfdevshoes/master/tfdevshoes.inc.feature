...
Feature: Tests for tfdevshoes in fdev
  ...
  @execute
  Scenario: tfdevshoes-master-inc
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/fdev/master/tfdevshoes/${version}/tfdevshoes.inc.conf
